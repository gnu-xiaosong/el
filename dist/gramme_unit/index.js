...
function text_deal(data) {
    ...
    try {
        for (var _iterator = text[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            try {
                for (var _iterator2 = item.reg_array[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var i = _step2.value;
...
function parse_output_html(data) {
    ...
    try {
        for (var _iterator3 = unit[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
// 标题
{
    ...
    parse_generate: function parse_generate(data) {
        // 一次解析并生成目标代码
...
// 分割线
{
    ...
    example: "-------- 或 *********  或 分割线",
    parse_generate: function parse_generate(data, reg) {

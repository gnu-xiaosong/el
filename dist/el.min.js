                    ...
                    var a = [{
                        ...
                        n = [{
                            ...
                            },
                            {
                                reg_array: ["```(.*)```"],
                                html_generate_array: [
                                    '<pre  style="background-color: black;color: aliceblue; padding-left:20px;padding-top:10px;padding-bottom:40px;width: 925px;border-radius: 5px;"><samp style="display:block; margin-top:5px;margin-left: 20px;">text</samp></pre>',
                                ],
                                description: "[代码片段]",
                                example: "",
                                parse_generate: function(e, r) {
